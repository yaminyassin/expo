...
export declare class NativeAsset {
    ...
    static create(filePath: string, album?: NativeAlbum): Promise<NativeAsset>;
    static delete(assets: NativeAsset[]): Promise<void>;
}
//# sourceMappingURL=NativeAsset.types.d.ts.map